...
struct ReservationForm: View {
    ...
    private var restaurant:RestaurantsLocation
    ...
    init(_ restaurant:RestaurantsLocation) {
...
struct ReservationForm_Previews: PreviewProvider {
    static var previews: some View {
        let restaurantsLocation = RestaurantsLocation(city: "Las Vegas", neighborhood: "Downtown", phoneNumber: "(702) 555-9898")
        ReservationForm(restaurantsLocation).environmentObject(Model())
    }
}
